...
#ifndef __MOTEINO_H__
#define __MOTEINO_H__
#include <Arduino.h>
...
class Moteino{
  ...
  public:
    Moteino(){};//Empty constructor
	virtual ~Moteino();
    Moteino(uint8_t &node_Id, uint8_t frequency, const char *encryptK, uint8_t netw_id, boolean mote_type=false);
    //int moteino_init();//
